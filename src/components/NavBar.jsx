  ...
  return (
        ...
        <Card noPadding={true}>
            <div className="px-4 py-2 flex justify-between md:block shadow-md shadow-gray-500 md:shadow-none">
                ...
                <a href="" className="flex gap-2 py-3 bg-pawBgFour text-white -mx-10 px-10 rounded-md shadow-md shadow-gray-300">
                ...
                <a href="" className="flex gap-2 py-3 hover:bg-pawBgOne -mx-10 px-10 rounded-md transition-all hover:scale-105 hover:shadow-md hover: shadow-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
