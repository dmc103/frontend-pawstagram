...
function NavBar() {
  ...
  const ActiveElement = 'flex gap-3 py-3 my-2 bg-pawBgFour text-white -mx-10 px-10 rounded-md shadow-md shadow-gray-300';

  const nonActiveElement = 'flex gap-3 py-2 my-2 hover:bg-pawBgOne -mx-10 px-10 rounded-md transition-all hover:scale-105 hover:shadow-md hover: shadow-gray-300';
  ...
  return (
        ...
        <Card noPadding={true}>
            <div className="px-4 py-2 flex justify-between md:block shadow-md shadow-gray-500 md:shadow-none">
                ...
                <span className="text-sm hidden md:block">Followers</span>
                </a>
                ...
                <span className="text-sm hidden md:block">Chat</span>
                </a>
                ...
                <span className="text-sm hidden md:block">Manage Profile</span>
                </a>
