...
function UserHome() {
  ...
  return (
    <div className="home w-full px-0 lg:px-10 pb-20 2xl:px-40 bg-pawBgTwo lg:rounded-lg h-screen overflow-hidden">
      <TopBar />
      <div className={"flex mt-4 max-w-4xl mx-auto gap-6 " + theme}>
        ...
        <div className={"w-3/4 " + theme}>
          <div className={theme}>
            <div
              className={
                "w-full max-w-XL bg-white border border-gray-200 rounded-lg shadow dark:bg-pawBgFour dark:border-emerald-300 color-bg " +
                theme
              }
            >
              <div className="flex flex-col items-center mt-7 pb-10">
                ...
                <div className="flex mt-4 md:mt-6">
                  <a
                    href="#"
                    className={
                      "inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white  bg-indigo-600  rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 button " +
                      theme
                    }
                  >
                    Add friend
