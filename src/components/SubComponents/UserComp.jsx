    ...
    <Card>
      ...
      >
        <div className="relative w-20 h-20 mt-8">
          <div
            className={
              "absolute inset-0 bg-pawBgFour rounded-full border-4 border-slate-50 group-hover:scale-150 group-hover:-translate-x-24 group-hover:-translate-y-20 transition-all duration-500 z-0 color-bg " +
              theme
            }
          ></div>
