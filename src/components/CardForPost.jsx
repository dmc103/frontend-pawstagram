...
function CardForPost() {
  ...
  return (
   ...
   <img src="../assets/samprofPic.jpg" alt="Profile" />
   </div>
   </div>

   
    <textarea className="w-full grow p-3 h-20 border-2 border-gray-300 rounded-md mb-2" placeholder="What's on your mind?"></textarea>
